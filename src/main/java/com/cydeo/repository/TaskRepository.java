...
public interface TaskRepository extends JpaRepository<Task, Long> {//entity, primary key
    ...
    List<Task> findAllByProject(Project project);//derives qr can pass entity(pass proj Id -  for other qr)
